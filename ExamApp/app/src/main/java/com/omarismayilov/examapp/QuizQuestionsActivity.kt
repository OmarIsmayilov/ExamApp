...
class QuizQuestionsActivity : AppCompatActivity() ,  View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionsList = Constrants.getQuestions()
                ...
                if (mSelectedOptionPosition == 0) {
                    ...
                    when {
                        ...
                        mCurrentPosition <= mQuestionsList!!.size -> {
                            ...
                            intent.putExtra(Constrants.CORRECT_ANSWERS, mCorrectAnswers)
                            intent.putExtra(Constrants.TOTAL_QUESTIONS, mQuestionsList!!.size)
                    ...
                    if (mCurrentPosition == mQuestionsList!!.size) {
                        btn_submit.text = "Sonlandır"
                    } else {
                        btn_submit.text = "Digər suala keç"
                    }
